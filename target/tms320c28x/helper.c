...
void HELPER(print_env)(CPUTms320c28xState *env) {
    ...
    qemu_log_mask(CPU_LOG_INT, "ST1=%04x\n", env->st1);
...
void HELPER(maxcul_p_loc32)(CPUTms320c28xState *env, uint32_t value)
{
